...
Phil_A() {
	//처음 젓가락을 집을 때 두 젓가락을 집는 동안 보호한다.
	Acquire(Lock);
...
void main(int argc, char *argv[])
{
	...
	key_t semkey4 = 201234220 + 3;
	key_t semkey5 = 2012342220 + 4;
	key_t semkey6 = 201232420 + 5;
	key_t semkey7 = 201234220 + 6;
